...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain (HttpSecurity http) throws Exception{
        ...
        return http
            ...
            .requestMatchers("/api/v1/customer/create-new-customer").hasRole("MANAGER")
            .requestMatchers("/api/v1/trailer/create-new-trailer").hasRole("MANAGER")
            .requestMatchers("/api/v1/customer/create-new-customer-test").hasRole("EMPLOYEE")
            .requestMatchers("/api/v1/customer/**").hasRole("ADMIN")
            .requestMatchers("/api/v1/user/**").hasRole("ADMIN")
            .requestMatchers("/api/v1/role/**").hasRole("ADMIN")
            .requestMatchers("/api/v1/trailer/**").hasRole("ADMIN")
            .anyRequest()
            .authenticated())
